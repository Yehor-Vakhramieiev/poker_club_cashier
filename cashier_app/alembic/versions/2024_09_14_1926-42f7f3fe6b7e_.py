...
Revision ID: 42f7f3fe6b7e
Revises: 
Create Date: 2024-09-14 19:26:14.607513
...
def upgrade() -> None:
    ...
    op.create_table('chips_quantity',
    ...
    op.create_index(op.f('ix_chips_quantity_id'), 'chips_quantity', ['id'], unique=False)
    ...
    op.create_table('credits_deposits',
    sa.Column('player_id', sa.Integer(), nullable=False),
    sa.Column('given_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('operation_type', sa.Enum('credit', 'deposit', name='creditdeposittype'), nullable=False),
    sa.Column('amount', sa.Integer(), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['player_id'], ['players.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_credits_deposits_id'), 'credits_deposits', ['id'], unique=False)
    ...
    op.create_table('cash_in_outs',
    sa.Column('player_session_id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('cash_in', 'cash_out', name='operationtype'), nullable=False),
    sa.Column('amount', sa.Integer(), nullable=False),
